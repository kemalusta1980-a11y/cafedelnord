...
- İterasyon 10: WhatsApp iletişim aktifleştirildi — numara 905342878402, karşılama mesajı "Merhaba, bilgi almak istiyorum." (settings.whatsapp_message, admin Ayarlar'dan değiştirilebilir). Buton href doğrulandı: wa.me/905342878402?text=... Numara normalizasyonu: baştaki 0 → 90. — zararsız ResizeObserver loop hataları craco devServer overlay filtresi + index.js global error listener ile bastırıldı. Testing agent: tüm sayfalar + resize/scroll stres testleri PASS, hiçbir overlay/hata yok (iteration_3.json)
